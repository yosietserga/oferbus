...
<div class="container" style="width: 95%; margin-left: 2.5%; background: #fff; text-align: left; padding: 0px 20px 20px 20px; font-size: 15px; box-shadow: 4px 0px 10px 0px rgba(0,0,0,.2); float: left; background: #2a2a2a; color: white">
    <h1 class="text-center titulo-paquete" style="margin-bottom: 0px">{$package->name} (Cupos desde {$packageorigen['origen']})</h1>
</div>
...
<div class="container" style="width: 95%; margin-left: 2.5%; background: #fff; text-align: left; padding: 20px; font-size: 15px; box-shadow: 4px 4px 10px 0px rgba(0,0,0,.4);">       
    <div class="col-sm-12">
        <div class="row" style="margin-top: 20px">
            ...
            <div class="col-sm-12"><strong>Descripción:</strong> {$packageDes}</div>
        </div>
        
        <div class="row" style="margin-top: 20px">
            <div class="col-sm-12 text-center" style="margin-bottom: 15px; background: #666; padding: 10px; color: white"><strong>lIQUIDACIÓN</strong></div>                            
            <div class="col-sm-6"><strong>Salida: &nbsp{$packageLineaSal} -- Llegada: {$packageLineaLLe}</strong></div>
            <div class="col-sm-6 text-right"><strong class="text-danger text-right">${$packageLinea['price']}</strong></div>
        </div>
        <hr class="col-sm-12">
        <div class="row">
            <div class="col-sm-8"><strong>Origen:&nbsp</strong> {$packageorigen['origen']}</div>            
            <div class="col-sm-4 text-right"><strong class="text-danger">${$packageorigen['price']}</strong></div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 text-right"><strong class="text-danger">${$packageButaca['price']}</strong></div>
        </div>
         <hr class="col-sm-12">
        <div class="row">
            <div class="col-sm-8"><strong>Impuestos:&nbsp</strong></div>            
            <div class="col-sm-4 text-right"><strong class="text-danger">${$packageLinea['impuesto']}</strong></div>
        </div>
        <hr class="col-sm-12">
        <div class="row">
            <div class="col-sm-8"><strong>Total del viaje:</strong></div>
            <div class="col-sm-4 text-right"><strong class="text-danger">${$packagehistorial->price}</strong></div>
        </div>

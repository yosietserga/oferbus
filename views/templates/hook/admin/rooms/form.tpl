...
<div id="total">
    <div class="panel" id="panelfotos" data-room="{$room|escape:'htmlall':'UTF-8'}" data-url="{$urlajax|escape:'htmlall':'UTF-8'}" style="margin-top: 13px;margin-left: 15px;">
                    ...
                    <tbody class="bodytablephotos">
                        {if !empty($photos)} 
                            {foreach from=$photos item=photo name=myLoop}
                                <tr>
                                    <td style="text-align:center;"><img src="{$urlviajero|escape:'htmlall':'UTF-8'}uploads/img/rooms/{$photo.id_room|escape:'htmlall':'UTF-8'}/{$photo.url|escape:'htmlall':'UTF-8'}" style="width:100px;">
                                    </td>
                                    <td>{$photo.url|escape:'htmlall':'UTF-8'}</td>
                                    <td>
                                        <div class="panel-heading-action">
                                            <a class="btn removephotoroom" data-room="{$photo.id_room|escape:'htmlall':'UTF-8'}" data-roomphoto="{$photo.id_room_photo|escape:'htmlall':'UTF-8'}" data-name="{$photo.url|escape:'htmlall':'UTF-8'}">

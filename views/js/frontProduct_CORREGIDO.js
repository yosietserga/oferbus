...
function loadDestinysLine(id_line) {
    ...
    $.ajax({
        ...
        success: function(destinations) {
			...
			content +=`<div class="col-12 mb-4"> <h5 class="fecha_salida subtitle-package ttline">Alojamientos para tu estadía</h5></div>`;
                      ...
                      //                        if(disponibilidad=='No'&& parseInt(room.cant)!== 0){
                                  ...
                                  if(isOpenedModal == 0){
									...
									$('#selectRoomTypeModal').on('hidden.bs.modal', function (e) {
                                      setTimeout(()=>{
                                          selectDestiniesLineDefault(true)
                                      }, 1000)
                                    });
...
let ClicAutoControl = false;
function selectDestiniesLineDefault(force = false) {

...
function validateForms() {
    ...
    arregloPasajeros.forEach(function(value, key) {
        if (value['NOMBRE'] === '' || value['APELLIDO'] === '' || value['DNI'] === ''
        ...
        <form id="formm-${inc}" class="col-md-12 col-xs-12">
            ...
            <div class="row">
				...
				<div class="col-md pl-md-2 col-xs-12">
                    ...
                    <div class="input-group mt-2">
                        <div class="no-uniform w-100">
                            <select class="form-control" data-no-uniform="true" id="tipoDoc" name="tipoDoc">
                ...
                <div class="col-md px-md-2 col-xs-12">
                    ...
                    <div class="input-group mt-2">
                        <input type="number" id="pasajeroDni" name="DNI" class="form-control" onkeypress='validate(event)' placeholder="">
                    </div>
                </div>
                <div class="col-md px-md-2 col-xs-12">
					<div class="input-group mt-2">
...
function recorrerPersonas(form) {
    ...
    for (var i = 0; i < rowsBody.length; i++) {
        var obj = {
            ...
            DNI: rowsBody[i].getElementById('pasajeroDni')[5].innerText
        }; /* auxiliar*/
...
function loadDestinysLine(id_line) {
    ...
    $.ajax({
        ...
        success: function(destinations) {
			...
			content +=`<div class="col-12 mb-4"> <h5 class="fecha_salida subtitle-package ttline">Alojamientos Seleccionados</h5></div>`;
                        ...
                        <div class="stay-panel-container panel-heading estadiaaccor seleccion_fecha seleccion_estadia" data-name-destiny="${ destiny.destiny }" data-destiny="${ destiny.id_destiny }" data-toggle="collapse"  data-parent="#container-destinations" data-target="#collapseCC${ destiny.id_destiny }">
                            <div class="row">								
                                <div class="col-12 d-flex justify-content-start align-items-center">
                                    ...
                                    <h5 class="panel-title ml-4">Ver alojamiento en ${ destiny.destiny } ↓</h5>
                                </div>
                            </div>
                        </div>
...
function loadHotelsDestiny(id, namedestiny) {
    var falgalready = 0;
    $.ajax({
        method: 'post',
        dataType: 'json',
        ...
        success: function(hotels) {
            ...
            $.each(hotels, function(key_hotel, hotel) {
                ...
                if (hotelSel !== 1 && hotel.group_rooms.length > 0) {
                    issetHotels = true;

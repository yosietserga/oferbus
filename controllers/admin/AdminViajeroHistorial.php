...
class AdminViajeroHistorialController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->_select="P.name, a.price, id_package_historial, firstname, lastname, state, a.date_add, PL.date_sal, OP.payment_method";
        ...
        LEFT JOIN `' . _DB_PREFIX_ . 'order_payment` OP ON (a.`reference` = OP.`order_reference`) ';
    ...
    public function renderView()
    {
        ...
        $packageorigen = ViajeroPaqueteHistorial::getOrigin2($packageLinea['id_package_historial']);
        ...
        //----
        $reference = ViajeroPaqueteHistorial::getReference(Tools::getValue('id_package_historial'));
        $metodoPago = ViajeroPaqueteHistorial::getPaymentMethod($reference);
        $servicios = ViajeroPaqueteHistorial::getServiceLine(Tools::getValue('id_package_historial'));
        $impuestos = ViajeroPaqueteHistorial::getImpuestos(Tools::getValue('id_package_historial'));
        //var_dump($impuestos);
        //---

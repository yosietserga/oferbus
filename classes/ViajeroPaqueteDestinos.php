...
//        exit();
    ...
    public static function getDestinosByOrigin($origin_id){
        $sql = 'SELECT DISTINCT des.*, lin.date_sal
                ...
                WHERE ori.id_origin = '.$origin_id.' 
                and lin.date_sal >= now()
                GROUP BY des.id_destiny ORDER BY des.id_destiny DESC';
                //GROUP BY des.id_destiny, lin.date_sal ORDER BY lin.date_sal DESC';

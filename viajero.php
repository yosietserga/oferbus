...
//        Configuration::updateValue('GROUPWRITERSALL', Tools::getValue('GROUPWRITERSALL'));
        ...
        foreach ($packagesHis as $packageHis) {
            ...
            */
            ...
            if($enviarMail == 0){
                ...
                $headers .= 'From: Oferbus <casacentral@oferbus.com.ar>' . "\r\n";
    ...
    <div class="container" style="width: 95%; margin-left: 2.5%; background: #fff; text-align: left; padding: 20px; font-size: 15px; box-shadow: 4px 4px 10px 0px rgba(0,0,0,.4);">       
        <div class="col-sm-12">
            ...
            <div class="row" style="margin-top: 20px">
                ...
                <div class="col-sm-6"><strong>Salida: '.$sal->format('d-m-Y').' -- Llegada: '.$lle->format('d-m-Y').' (Horario Salida: se informa 48hs previo embarque, via e-mail)</strong></div>
            </div>
            <hr class="col-sm-12">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">'.$servicios.' Incluye Asistencia al Viajero</div>
            </div>
            <hr class="col-sm-12">
            <div class="row">
            ...
            <hr class="col-sm-12">
            <div class="row">													
                <div class="col-sm-8"><strong>Impuesto: </strong><span style="font-size: 25px;">$ '.number_format($packageHistorial->price-($packageHistorial->price/1.21), 2, '.', '').'</span></div>
            </div>
            <hr class="col-sm-12">
            <div class="row">
                <div class="col-sm-8"><strong>Total: </strong><span style="font-size: 25px;">$ '.number_format($packageHistorial->price, 2, '.', '').'</span></div>
            </div>
            <hr class="col-sm-12">'
                ;
                $body .='<div class="row">
            ...
            <hr class="col-sm-12">';
                ...
                foreach($packagePasajeros as $pasajeros){
                    ...
                    $body .='<div class="col-sm-3"><strong>Nombre y Apellido: </strong></div>
    ...
    <div align="center">
    <td align="center" class="logo" style="border-bottom: 4px solid #333333; padding: 7px 0;"> <img src="data:image/jpeg;base64,/)    /)                     '            ��&    x/)            0/)     @      0/)            "/> </a></td>
    </div>
    <div class="container" style="width: 95%; margin-left: 2.5%; background: #fff; text-align: left; padding: 0px 20px 20px 20px; font-size: 15px; box-shadow: 4px 0px 10px 0px rgba(0,0,0,.2); float: left; background: #2a2a2a; color: white">
        <h1 class="text-center titulo-paquete" style="margin-bottom: 0px">'.$package->name.' (Salida: '.$fechaTxt.')</h1>
    </div>
